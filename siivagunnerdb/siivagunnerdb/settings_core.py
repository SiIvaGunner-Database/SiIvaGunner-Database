...
INSTALLED_APPS = [
    ...
    'siivagunnerdb.drive.forms',
    'siivagunnerdb.drive.scripts',
...
ROOT_URLCONF = 'siivagunnerdb.urls'
...
WSGI_APPLICATION = 'siivagunnerdb.wsgi.application'
...
# Automatic primary key model fields
